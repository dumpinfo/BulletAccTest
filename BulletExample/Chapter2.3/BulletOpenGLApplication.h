...
public:
	...
	// camera functions
	void UpdateCamera();
/*ADD*/		void RotateCamera(float &angle, float value);
/*ADD*/		void ZoomCamera(float distance);
...
/*ADD*/		float m_cameraDistance; // distance from the camera to its target
/*ADD*/		float m_cameraPitch; // pitch of the camera 
/*ADD*/		float m_cameraYaw; // yaw of the camera
