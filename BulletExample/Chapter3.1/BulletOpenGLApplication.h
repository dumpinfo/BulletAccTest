...
/*ADD*/		// physics functions. Can be overriden by derived classes (like BasicDemo)
/*ADD*/		virtual void InitializePhysics() {};
/*ADD*/		virtual void ShutdownPhysics() {};
...
/*ADD*/		// core Bullet components
/*ADD*/		btBroadphaseInterface* m_pBroadphase;
/*ADD*/		btCollisionConfiguration* m_pCollisionConfiguration;
/*ADD*/		btCollisionDispatcher* m_pDispatcher;
/*ADD*/		btConstraintSolver* m_pSolver;
/*ADD*/		btDynamicsWorld* m_pWorld;
